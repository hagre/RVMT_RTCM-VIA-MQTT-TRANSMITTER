...
*/
#ifndef rtcmstreaminput_h
#define rtcmstreaminput_h

#define MAX_BUFFFERSIZE 1030
class RTCMStreamInput
{
private:
    bool _inLine;
    uint8_t _inputStreamHash [3];
    uint8_t _receiveStream[MAX_BUFFFERSIZE];
...
public:
    ...
    uint8_t outputStream[MAX_BUFFFERSIZE];
